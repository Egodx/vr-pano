            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-bordered" style="padding-bottom:5px;">
                    ...
                    <div class="panel-body ">
                        @inject('pano', 'App\Data\Panorama')
                        <a target="_blank" href="/uploads/{{ $pano->find($dataTypeContent->id)->slug() }}.jpeg"><img class="img-responsive" src="/uploads/{{ $pano->find($dataTypeContent->id)->slug() }}.preview.jpeg" alt="preview"></a>
                    </div>
                </div>
            </div>
        </div>
